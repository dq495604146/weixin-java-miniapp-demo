...
/**
 * @ClassName HttpClient @Description TODO @Author cc @Date 2023/6/8 3:14 下午 @Version 1.0
 */
@Component
public class HttpClient {

  /**
   * 默认参数设置 setConnectTimeout：设置连接超时时间，单位毫秒。 setConnectionRequestTimeout：设置从connect
   * Manager获取Connection 超时时间，单位毫秒。 setSocketTimeout：请求获取数据的超时时间，单位毫秒。访问一个接口，多少时间内无法返回数据，就直接放弃此次调用。
   * 暂时定义15分钟
   */
